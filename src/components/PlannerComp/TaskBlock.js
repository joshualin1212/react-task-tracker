const TaskBlock = ({ hour, minute, onDrop, dayPlanTask }) => {
  ...
  // During the first occurence, we put in a task. We stretch the gridRow according to the duration (numBlocksOccupied).
